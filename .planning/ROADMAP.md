...
- [ ] **Phase 1: Transport Normalization and Observability** - Canonicalize packet ingress so transport bugs stop masquerading as gameplay bugs.
...
- [ ] `01-02-PLAN.md` — Add transport counters, debug summaries, and transport contract documentation on top of the canonical ingress path.
...
|-------|----------------|--------|-----------|
| 1. Transport Normalization and Observability | 1/2 | In Progress | 2026-04-08 |
| 2. Reconciliation Contract | 0/TBD | Not started | - |
