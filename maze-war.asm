...
NS_INIT	=	NS_BASE+30
;
NET_FLAGS	=	$06	;REGISTER + external TX, internal RX
...
VBI	LDA	NET_ACTIVE
	...
	BEQ	VBI_NO_NET
	JSR	NET_RX_STEP
VBI_NO_NET	LDX	ACTIVE	;INIT LOOP COUNT
...
;
;REMOTE ZOMBIE INPUT (NETSTREAM)
;
NETMVE	LDA	NET_RX_STICK	;READ NET STICK
	EOR	#$0F	;IF IT IS MOVED,
	BNE	TRYDIR	;DO IT
	JMP	CHKSHOT	;ELSE, DO SHOTS
;
...
CHKTRIG	LDA	#0	;CLR ATRACT SINCE
	...
	BNE	CHKTRGO
	BEQ	INITSHOT
CHKTRPLR	LDA	STRIG0,X	;TRIG PRESSED?
CHKTRGO	BEQ	INITSHOT	;YES, START SHOT
